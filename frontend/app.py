        ...
        with st.spinner("AI Agents are architecting your journey..."):
            try:
                ...
                if trip_id:
                    ...
                    with dl1:
                        st.markdown(f"<a href='{backend_url}/api/download/{trip_id}/pdf' target='_blank'><button style='width:100%;background:rgba(255,255,255,0.1);color:#dfc059;border:1px solid rgba(223,192,89,0.5);padding:12px;border-radius:8px;font-weight:600;letter-spacing:1px;cursor:pointer;transition:all 0.3s;backdrop-filter:blur(5px);' onmouseover=\"this.style.background='rgba(223,192,89,0.2)';this.style.borderColor='#dfc059'\" onmouseout=\"this.style.background='rgba(255,255,255,0.1)';this.style.borderColor='rgba(223,192,89,0.5)'\">📄 Download PDF Itinerary</button></a>", unsafe_allow_html=True)
                    with dl2:
                        st.markdown(f"<a href='{backend_url}/api/download/{trip_id}/ics' target='_blank'><button style='width:100%;background:rgba(255,255,255,0.05);color:#fff;border:1px solid rgba(255,255,255,0.3);padding:12px;border-radius:8px;font-weight:600;letter-spacing:1px;cursor:pointer;transition:all 0.3s;backdrop-filter:blur(5px)' onmouseover=\"this.style.background='rgba(255,255,255,0.15)';this.style.borderColor='rgba(255,255,255,0.5)'\" onmouseout=\"this.style.background='rgba(255,255,255,0.05)';this.style.borderColor='rgba(255,255,255,0.3)'\">📅 Sync Apple/Google Calendar</button></a>", unsafe_allow_html=True)
